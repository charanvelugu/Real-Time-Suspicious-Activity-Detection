...
# Video path
cap = cv2.VideoCapture('C:\Rupesh\OneDrive\Documents\charan_project\proglint2\object_blurring_output.mp4')
...
frame_total = 2000
i = 0
a = 437 # Start from 848 forcefully

all_data = []

# Define output path for cropped images
output_path_dir = r'C:\Rupesh\OneDrive\Documents\charan_project\proglint2\images1'
...
while cap.isOpened():
    ...
    pa = r'C:\Rupesh\OneDrive\Documents\charan_project\proglint2\images'
...
csv_file_path = r'C:\Rupesh\OneDrive\Documents\charan_project\proglint2\nkeypoint.csv'
