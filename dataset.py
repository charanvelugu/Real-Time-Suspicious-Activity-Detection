...
df = pd.read_csv(r'C:\Rupesh\OneDrive\Documents\charan_project\proglint2\dataset_path\nkeypoint.csv')

dataset_path = r'C:\Rupesh\OneDrive\Documents\charan_project\proglint2\dataset_path'
