...
cap = cv2.VideoCapture('C:\Rupesh\OneDrive\Documents\charan_project\proglint2\WhatsApp Video 2024-10-24 at 12.01.17 PM.mp4')
...
video_writer = cv2.VideoWriter("C:\Rupesh\OneDrive\Documents\charan_project\proglint2\object_blurring_output.mp4", cv2.VideoWriter_fourcc(*"mp4v"), fps, frame_size)
